$(function() {
    ...
    var pageGridConfig = {
        ...
        columns: [
            [
                ...
                { field: 'position', title: '位置', align: 'center', width: '20%' },
                { field: 'desc', title: '描述', align: 'center', width: '20%' },
                { field: 'time', title: ' 创建时间', align: 'center', width: '19%' },
                {
                    field: 'operate',
                    title: '操作',
                    width: '20%',
    ...
    function renderOperateBtns(value, row, index) {
        return '<div class="operate-wrap">'
                ...
                +'<a href="javascript:void(0);" data-title="'+row.title+'" data-href="' + row.previewLink + '" data-id="' + row.id + '" class="operate-btn ">内容</a>'
    ...
    //********使用本地数据测试,上线时删除********//
    //$('#dataGrid').datagrid('loadData', adListData);
    //********使用本地数据测试,上线时删除********//
