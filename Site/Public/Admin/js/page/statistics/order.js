$(function() {
    ...
    var pageGridConfig = {
        ...
        columns: [
            [
                { field: 'orderNo', title: '订单号', align: 'center', width: '15%' },
                { field: 'buyer', title: '采购商', align: 'center', width: '15%' },
                { field: 'company', title: '供应商', align: 'center', width: '15%' },
                { field: 'total', title: '总金额', align: 'center', width: '15%' }, 
                { field: 'createTime', title: '创建时间', align: 'center', width: '15%' },
                { field: 'status', title: '订单状态', align: 'center', width: '24%' }
            ]
        ],
        singleSelect: false
    }
    ...
    //********使用本地数据测试,上线时删除********//
    //$('#dataGrid').datagrid('loadData', statisticsOrderData);
    //********使用本地数据测试,上线时删除********//
