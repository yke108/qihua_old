$(function() {
    ...
    var pageGridConfig = {
        ...
        columns: [
            [
                { field: 'name', title: '公司名称', align: 'center', width: '32%' },
                { field: 'status', title: '认证状态', align: 'center', width: '32%' }, 
                {
                    field: 'operate',
                    title: '操作',
                    width: '32%',
    ...
    //********使用本地数据测试,上线时删除********//
    $('#dataGrid').datagrid('loadData', companyData);
    //********使用本地数据测试,上线时删除********//
