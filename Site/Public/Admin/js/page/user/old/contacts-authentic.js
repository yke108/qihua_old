$(function() {
    ...
    var pageGridConfig = {
        ...
        columns: [
            [
                { field: 'name', title: '公司名称', align: 'center', width: '24%' },
                { field: 'contacts', title: '联系人资料', align: 'center', width: '24%' },
                { field: 'status', title: '认证状态', align: 'center', width: '24%' }, {
                    field: 'operate',
                    title: '操作',
                    width: '24%',
                    align: 'center',
    ...
    //********使用本地数据测试,上线时删除********//
    $('#dataGrid').datagrid('loadData', contactsData);
    //********使用本地数据测试,上线时删除********//
